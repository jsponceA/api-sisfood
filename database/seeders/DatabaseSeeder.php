    ...
    public function run(): void
    {
       ...
       /* User::query()->create([
        ...
        $workes = [
            ...
            ["dni" => "41368139", "nombre" => "ALIAGA HUAYTA DAVID MIGUEL", "fecha" => "2025-10-17", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "70573430", "nombre" => "BELLIDO QUISPE JAIME DARIO", "fecha" => "2025-10-06", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "42316497", "nombre" => "CASTRO ACHO EDSON", "fecha" => "2025-10-27", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "46684079", "nombre" => "CHAVEZ PRADO LIZET ANTONIA", "fecha" => "2025-10-16", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "48588209", "nombre" => "CORDOVA ROJAS MACEDONIO", "fecha" => "2025-09-15", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "80232243", "nombre" => "CRUZ SILVANO LIMBER", "fecha" => "2025-09-03", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "76496204", "nombre" => "CUMARI UTIA JOSIAS LUIS", "fecha" => "2025-08-20", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "75992009", "nombre" => "DAVILA MOMTALVAN DAVOR OWEN ALESSANDRO", "fecha" => "2025-11-14", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "43076272", "nombre" => "FASABI CASTILLO EDINSON", "fecha" => "2025-08-14", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],

            // Registro invertido corregido
            ["dni" => "61949076", "nombre" => "GAMBOA VARGAS INES JUANA", "fecha" => "2025-11-14", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],

            ["dni" => "76148495", "nombre" => "GARCIA OCHOA CESAR BENJAMIN", "fecha" => "2025-10-06", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "63336396", "nombre" => "GONZALES FERNANDEZ JIMMY STALYN", "fecha" => "2025-08-11", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "40564004", "nombre" => "GUINEA OVALLE MARCIAL", "fecha" => "2025-10-10", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "76994897", "nombre" => "HUARANGA NARCIZO JERSON", "fecha" => "2025-09-17", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "40282193", "nombre" => "ISHUIZA SINARAHUA ABNER", "fecha" => "2025-09-23", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "48182438", "nombre" => "LOPEZ HUAMANI MILAGROS MEDALIT", "fecha" => "2025-10-20", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "76669181", "nombre" => "MONDALUISA SILVANO DEIVIS CRISTIAN", "fecha" => "2025-11-12", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "45116076", "nombre" => "NOLORBE MAFALDO DIANA CAROLINA", "fecha" => "2025-10-13", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "44985630", "nombre" => "ORTIZ MUÑOZ VICTOR EDUARDO", "fecha" => "2025-09-23", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "76454275", "nombre" => "OROCHE RUIZ ROSMERY MALENA", "fecha" => "2025-11-12", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "49079247", "nombre" => "RODRIGUEZ FERNANDEZ ALEX GABRIEL", "fecha" => "2025-10-16", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "62874745", "nombre" => "SALINAS CHAVEZ KEBIN ANIBAL", "fecha" => "2025-11-03", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "63096269", "nombre" => "SILVA ANDI CARLOS ANTONIO", "fecha" => "2025-11-03", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "73368743", "nombre" => "TAIPE PACHECO DORIS", "fecha" => "2025-10-06", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "74549231", "nombre" => "TAPULLIMA PASHANASI ELISEO", "fecha" => "2025-09-23", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "46504848", "nombre" => "TORRES PALACIOS JULIO CESAR", "fecha" => "2025-08-18", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "46301119", "nombre" => "TUNQUI TAPARA OSCAR VIDAL", "fecha" => "2025-09-11", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "62614058", "nombre" => "VALERA ARCENTALES JHORLIN OLIVER", "fecha" => "2025-11-03", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "62874388", "nombre" => "VASQUEZ CAHUACHI JEFERSON", "fecha" => "2025-09-23", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "44864994", "nombre" => "VILCA TACUCHE HERMELINDA DORCAS", "fecha" => "2025-09-29", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],

            // Corregido nombre entre comillas
            ["dni" => "43525128", "nombre" => "VASQUEZ SANCHEZ JOSE ANTONIO", "fecha" => "2025-11-18", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],

            ["dni" => "45968248", "nombre" => "YRCAÑAUPA ANDRADE SILVIA MARGOT", "fecha" => "2025-10-27", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "62440729", "nombre" => "YUIMACHI TAMANI JOSE JOEL", "fecha" => "2025-11-14", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0],
            ["dni" => "43982757", "nombre" => "YUPANQUI LLACTAHUAMAN RAFAEL", "fecha" => "2025-09-02", "area" => "PRODUCCION", "subvencion_parcial" => 1, "subvencion_completa" => 0]
        ];
