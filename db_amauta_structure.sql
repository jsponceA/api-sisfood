...
MySQL - 8.0.20 : Database - db_lucemir_amauta
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_lucemir_amauta` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `db_lucemir_amauta`;
...
CREATE TABLE `products` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` enum('BEBIDAS','COMIDAS','SNACK','EXTRAS') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sale_details` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51561 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sales` (
  ...
  `num_document` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `deal_in_form` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pay_type` enum('CREDITO','EFECTIVO') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51296 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `superiors` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `names` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `workers` (
  ...
  `personal_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `names` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `surnames` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numdoc` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
